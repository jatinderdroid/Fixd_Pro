...
public class InviteByPhoneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_invite_mobile);
    ...
    private void setListeners(){
        ...
        txtInvite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Utility.hideKeyBoad(InviteByPhoneActivity.this,txtInput);
                input = txtInput.getText().toString().trim();
                if (input.length() == 0) {
                    checkALert.showcheckAlert(InviteByPhoneActivity.this, InviteByPhoneActivity.this.getResources().getString(R.string.alert_title), "Please enter mobile number.");
                } else {
//                    call api
                    sendInviteRequest();
                }
    ...
    private HashMap<String,String> getInviteParams(){
        ...
        hashMap.put("api","invite_phone");
        hashMap.put("object","referral");
        hashMap.put("data[phone]",input);
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case 1:{
                    checkALert.showcheckAlert(InviteByPhoneActivity.this, InviteByPhoneActivity.this.getResources().getString(R.string.alert_title), error_message);
                    break;
                }
            }
