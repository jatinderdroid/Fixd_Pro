...
public class CompletePlans extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_plans);
        ...
        CompletePlanAdapter adapter = new CompletePlanAdapter(this,warrentyPlanBean.getSimplePlansBeanArrayList(),getResources());
    ...
    private void setFooter(){
        ...
        btnPurchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isnew){
                    if (_prefs.getString(Preferences.HAS_CARD,"0").equals("1")){
//                    do purchase
                        subscripbePlan();
                    }else{
...
//                AddressesSingleTonClasses.getInstance().arrayListFileAClain.clear();
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 0:{
                    Intent intent = new Intent(CompletePlans.this,HomeActivity.class);
                ...
                case 1:{
                    checkALert.showcheckAlert(CompletePlans.this, getResources().getString(R.string.alert_title), error_message);
                    break;
                }
                case 2:{
                    subscripbePlan();
        ...
        txtSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (card_number.length() == 0) {
                    checkALert.showcheckAlert(CompletePlans.this, getString(R.string.alert_title), "please enter card number");
                } else if (card_number.length() != 16) {
                    checkALert.showcheckAlert(CompletePlans.this, getString(R.string.alert_title), "please enter a valid card number");
                } else if (month.length() == 0) {
                    checkALert.showcheckAlert(CompletePlans.this, getString(R.string.alert_title), "please enter month");
                } else if (year.length() == 16) {
                    checkALert.showcheckAlert(CompletePlans.this, getString(R.string.alert_title), "please enter a year");
                } else if (year.length() < 4) {
                    checkALert.showcheckAlert(CompletePlans.this, getString(R.string.alert_title), "please enter a valid a valid year");
                } else if (cvv.length() == 0) {
                    checkALert.showcheckAlert(CompletePlans.this, getString(R.string.alert_title), "please enter CVV");
                } else if (cvv.length() < 3) {
                    checkALert.showcheckAlert(CompletePlans.this, getString(R.string.alert_title), "please enter a valid a CVV number");
                }
//                else if (zip_code.length() == 0) {
//                    checkALert.showcheckAlert(CompletePlans.this, getString(R.string.alert_title), "please enter Zip");
//                }
                else if (first_name.length() == 0) {
                    checkALert.showcheckAlert(CompletePlans.this, getString(R.string.alert_title), "please enter first name");
                } else if (last_name.length() == 0) {
                    checkALert.showcheckAlert(CompletePlans.this, getString(R.string.alert_title), "please enter last name");
                } else {
                    GetApiResponseAsync apiResponseAsync = new GetApiResponseAsync(Constants.BASE_URL_SINGLE, "POST", addCardResponseListener, addCardExceptionListener, CompletePlans.this, "Scheduling");
...
//                    HomeServiceSingleTon.getInstance().setList(arrayList);
    ...
    public void onScanPress(View v) {
        Intent scanIntent = new Intent(CompletePlans.this, CardIOActivity.class);
