...
public class JobModal implements Serializable{
    ...
    private ArrayList<JobAppliancesModal> job_appliances_arrlist = new ArrayList<>();
    ...
    String job_customer_addresses_longitude = "(null)";
    String job_customer_addresses_latitude = "(null)";

    public String getJob_customer_addresses_longitude() {
        return job_customer_addresses_longitude;
    }

    public void setJob_customer_addresses_longitude(String job_customer_addresses_longitude) {
        this.job_customer_addresses_longitude = job_customer_addresses_longitude;
    }

    public String getJob_customer_addresses_latitude() {
        return job_customer_addresses_latitude;
    }

    public void setJob_customer_addresses_latitude(String job_customer_addresses_latitude) {
    ...
    String is_claim = "0";
    String customer_warranty_plan_id = "0";
    ...
    public String getCustomer_warranty_plan_id() {
        return customer_warranty_plan_id;
    }

    public void setCustomer_warranty_plan_id(String customer_warranty_plan_id) {
        this.customer_warranty_plan_id = customer_warranty_plan_id;
    }
}
