 ...
 */
public class WhatTypeOfProjectAdapter extends BaseAdapter {
    ...
    public WhatTypeOfProjectAdapter(Activity a, ArrayList d,Resources resLocal) {
...
//            Log.i("", "lstheight"+lstheight);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            vi = inflater.inflate(R.layout.item_what_type_of_project, null);
...
//            holder.lbldescription.setText(tempValues.getName());
            holder.lblname.setText(tempValues);
        }
        return vi;
    }
